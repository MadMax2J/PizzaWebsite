...
// calculate price
    ...
    document.getElementById("price").setAttribute("value", pizzaPrice);
...
Anchovies
     ...
     <h3>Total Price is: €<span id="pricetext">18</span></h3>
        <input id="price" name="price" hidden="true" value="18"/>
...
Name:
        ...
        <input id="studentdiscount" type="checkbox" name="student" value="yes" onChange="redraw()" checked/>
